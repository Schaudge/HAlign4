...
auto star_alignment::StarAligner::_pairwise_align() const -> std::vector<std::array<std::vector<utils::Insertion>, 2>>
{
    ...
    suffix_array::SuffixArray<nucleic_acid_pseudo::NUMBER> st(_sequences[_centre].cbegin(), _sequences[_centre].cend(),nucleic_acid_pseudo::end_mark);//ʵ������׺������st���ȶ�ͬԴ����
    ...
    for (size_t i = 0; i != _row; ++i)
    {
        ...
        for (size_t j = 0; j != intervals.size(); ++j)
        {
            ...
            auto [lhs_gaps, rhs_gaps] = mywfa(aligner, _sequences[_centre], centre_begin, centre_end,  //��ͬԴ���򣬶�̬�滮�ȶ�
...
{
    cout_cur_time();
    const auto align_1 = std::chrono::high_resolution_clock::now(); //��¼�ȶ���ʼʱ��
    ...
    std::vector<std::array<std::vector<utils::Insertion>, 2>> pairwise_gaps(_row); //�������-���ս��
